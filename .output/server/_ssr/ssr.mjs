import { _ as isResolvedRedirect, d as require_jsx_runtime, g as isRedirect, h as executeRewriteInput, i as RouterProvider, m as resolveManifestAssetLink, t as renderRouterToStream, v as rootRouteId, x as invariant, y as isNotFound } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ExDmfa9V.mjs");
...
async function loadEntries() {
	const routerEntry = await import("./router-CXj_E2lG.mjs");
	return {
		startEntry: await import("./start-S6R1ogjB.mjs"),
		routerEntry
	};
}
function getEntries() {
